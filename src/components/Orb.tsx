...
export default function Orb({
  ...
  const colorPalettes: Record<Exclude<ColorTheme, 'custom'>, { primary: number[]; secondary: number[]; accent: number[] }> = {
    gold: {
      ...
      accent: [0.8, 0.6, 0.0]         // #CC9900
    },
    bronze: {
      primary: [0.8, 0.5, 0.2],       // #CC6633
      secondary: [0.6, 0.4, 0.2],     // #996633
      accent: [0.4, 0.3, 0.1]         // #664D1A
    },
    silver: {
      primary: [1.0, 1.0, 1.0],       // #FFFFFF - Pure white
      secondary: [0.95, 0.95, 1.0],   // #F2F2FF - Very light blue-white
      accent: [0.9, 0.9, 0.95]        // #E6E6F2 - Light blue-white
    },
    metallic: {
      primary: [0.7, 0.7, 0.8],       // #B3B3CC
      secondary: [0.5, 0.5, 0.6],     // #808099
      accent: [0.3, 0.3, 0.4]         // #4D4D66
    },
    cyan: {
      primary: [0.0, 0.97, 1.0],      // #00F7FF
      secondary: [0.0, 0.8, 0.9],     // #00CCE6
      accent: [0.0, 0.6, 0.7]         // #0099B3
    }
  };
  ...
  const frag = /* glsl */ `
    ...
    // Colors are now passed as uniforms
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        primaryColor: { value: new Vec3(colors.primary[0], colors.primary[1], colors.primary[2]) },
        secondaryColor: { value: new Vec3(colors.secondary[0], colors.secondary[1], colors.secondary[2]) },
        accentColor: { value: new Vec3(colors.accent[0], colors.accent[1], colors.accent[2]) },
        hover: { value: 0 },
        rot: { value: 0 },
