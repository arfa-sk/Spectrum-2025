...
export const metadata: Metadata = {
  ...
  description: "Register for Spectrum 2026 - Pakistan's Premier Tech Festival. Join us for Hackathons, E-Sports, and Suffa's Got Talent competitions with PKR 400,000+ in prizes.",
